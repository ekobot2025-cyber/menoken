        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-5 flex flex-col items-start text-left">
              ...
              {/* Dual Action Buttons (Toba-Quest Exact Styles) */}
              <div className="flex flex-wrap sm:flex-nowrap items-center gap-4 w-full sm:w-auto mb-8">
                {/* Primary Button: START YOUR ADVENTURE */}
                <button
                  onClick={() => { setAuthTab('login'); setShowAuthModal(true); }}
                  className="w-full sm:w-auto px-7 py-4 rounded-2xl bg-gradient-to-r from-cyan-400 to-blue-600 text-slate-950 font-extrabold text-base sm:text-lg hover:scale-105 transition-transform shadow-xl shadow-cyan-500/40 flex items-center justify-center gap-2.5 cursor-pointer select-none"
                >
                  <Rocket className="w-5 h-5 text-slate-950" />
                  <span>MULAI WIRAUSAHA</span>
                </button>

                {/* Secondary Button: DISCOVER HOW IT WORKS */}
                <a
                  href="#how-it-works"
